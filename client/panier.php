...
<body>
    ...
    {
        array_push($_SESSION['panier']['nomProduit'], $select['nomProduit']);
        array_push($_SESSION['panier']['quantite'], $select['qte']);
        array_push($_SESSION['panier']['prix'], $select['prix']);
        array_push($_SESSION['panier']['idProduit'], $select['idProduit']);
    }

    $select = array();
    $select['nomProduit'] = $_POST['nomProduit'];
    $select['qte'] = $_POST['quantite'];
    $select['prix'] = $_POST['prix'];
    $select['idProduit'] = $_POST['idProduit'];
